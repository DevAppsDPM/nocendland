  ...
  public menuItems: SIDE_NAV_MENU_CATEGORIES[] = [
    {
      ...
      buttons: [
        ...
        { title: 'Alimentación', description: 'Calorías y control de la comida', icon: 'fastfood', route: ROUTES.MODULES.LLIMBRO.ROUTE + '/' +  ROUTES.MODULES.LLIMBRO.NUTRITION + '/' + ROUTES.MODULES.LLIMBRO.INTAKE },
      ]
    },
    {
      title: 'Llimbro',
