...
export class SupabaseService {
  ...
  public signInGithub(): Promise<OAuthResponse> {
    return this.client.auth.signInWithOAuth({ provider: 'github', options: { redirectTo: this.authRedirectUrl } })
  }

  public signInGoogle(): Promise<OAuthResponse> {
    return this.client.auth.signInWithOAuth({ provider: 'google', options: { redirectTo: this.authRedirectUrl } })
  }
