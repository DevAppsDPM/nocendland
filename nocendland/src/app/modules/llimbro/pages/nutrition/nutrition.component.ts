...
export class NutritionComponent implements AfterViewInit, OnDestroy {
  private footerButtons: FOOTER_BUTTON[] = [
    ...
    { icon: 'analytics', text: STRING.MODULES.LLIMBRO.CHILDREN.NUTRITION.COMPONENTS.OBJECTIVES.NAME, action: () => this.navigateNutritionModule(ROUTES.MODULES.LLIMBRO.OBJECTIVES.ROUTE)},
  ...
  private NUTRITION_MODULES: Record<number, string> = {
    ...
    2: ROUTES.MODULES.LLIMBRO.OBJECTIVES.ROUTE,
  }
